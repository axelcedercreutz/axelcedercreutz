...
**Product engineer.** I build products end to end: interface, data model, pipeline, deploy, and the on-call after. Building web applications since 2016: five years at Twice Commerce (formerly Rentle) as software engineer and analytics lead, and since October 2024 product engineer at [Gosta Labs](https://gostalabs.com), a Helsinki healthcare AI startup building an AI operating system for oncology teams.
...
- **Banger Board** — a fantasy hockey draft platform for a league whose scoring makes public rankings wrong: value over replacement, gain-over-waiting suggestions, a mock-draft simulator, live market data and two-device draft-night sync. [Live app](https://nhl-fantasy-draft-tool-axelcedercreutzs-projects.vercel.app/).
